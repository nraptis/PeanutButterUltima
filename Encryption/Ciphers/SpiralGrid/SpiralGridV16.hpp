#ifndef JELLY_SPIRAL_GRID_V16_HPP_
#define JELLY_SPIRAL_GRID_V16_HPP_
...
class SpiralGridV16 final : public Crypt {
 public:
  explicit SpiralGridV16(int pAmount) : mAmount(pAmount) {}
...
#endif  // JELLY_SPIRAL_GRID_V16_HPP_
