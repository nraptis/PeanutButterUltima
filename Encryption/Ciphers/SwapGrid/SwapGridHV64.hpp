#ifndef JELLY_SWAP_GRID_HV64_HPP_
#define JELLY_SWAP_GRID_HV64_HPP_
...
class SwapGridHV64 final : public Crypt {
 public:
    ...
    for (std::size_t aOffset = 0; aOffset < pLength; aOffset += kTileSize) {
      for (std::size_t aCol = 0; aCol < kDim; ++aCol) {
        ...
        pDestination[aDestinationBase + 0] =
            pSource[aOffset + ((0u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 1] =
            pSource[aOffset + ((1u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 2] =
            pSource[aOffset + ((2u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 3] =
            pSource[aOffset + ((3u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 4] =
            pSource[aOffset + ((4u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 5] =
            pSource[aOffset + ((5u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 6] =
            pSource[aOffset + ((6u << 3) + (aCol ^ 1u))];
        pDestination[aDestinationBase + 7] =
            pSource[aOffset + ((7u << 3) + (aCol ^ 1u))];
      }
    }
  ...
  static bool ApplyDecrypt(const unsigned char* pSource,
    ...
    for (std::size_t aOffset = 0; aOffset < pLength; aOffset += kTileSize) {
      for (std::size_t aRow = 0; aRow < kDim; ++aRow) {
        ...
        pDestination[aDestinationBase + 0] =
            pSource[aOffset + ((1u << 3) + aRow)];
        pDestination[aDestinationBase + 1] =
            pSource[aOffset + ((0u << 3) + aRow)];
        pDestination[aDestinationBase + 2] =
            pSource[aOffset + ((3u << 3) + aRow)];
        pDestination[aDestinationBase + 3] =
            pSource[aOffset + ((2u << 3) + aRow)];
        pDestination[aDestinationBase + 4] =
            pSource[aOffset + ((5u << 3) + aRow)];
        pDestination[aDestinationBase + 5] =
            pSource[aOffset + ((4u << 3) + aRow)];
        pDestination[aDestinationBase + 6] =
            pSource[aOffset + ((7u << 3) + aRow)];
        pDestination[aDestinationBase + 7] =
            pSource[aOffset + ((6u << 3) + aRow)];
      }
    }
...
#endif  // JELLY_SWAP_GRID_HV64_HPP_
