#ifndef JELLY_SWAP_GRID_VH16_HPP_
#define JELLY_SWAP_GRID_VH16_HPP_
...
class SwapGridVH16 final : public Crypt {
 public:
 ...
 private:
  ...
  static bool Apply(const unsigned char* pSource,
    ...
    for (std::size_t aOffset = 0; aOffset < pLength; aOffset += kTileSize) {
      ...
      pDestination[aOffset + 2] = pSource[aOffset + 6];
      pDestination[aOffset + 3] = pSource[aOffset + 7];
      pDestination[aOffset + 4] = pSource[aOffset + 0];
      pDestination[aOffset + 5] = pSource[aOffset + 1];
      pDestination[aOffset + 6] = pSource[aOffset + 2];
      pDestination[aOffset + 7] = pSource[aOffset + 3];
      pDestination[aOffset + 8] = pSource[aOffset + 12];
      pDestination[aOffset + 9] = pSource[aOffset + 13];
      pDestination[aOffset + 10] = pSource[aOffset + 14];
      pDestination[aOffset + 11] = pSource[aOffset + 15];
      pDestination[aOffset + 12] = pSource[aOffset + 8];
      pDestination[aOffset + 13] = pSource[aOffset + 9];
...
#endif  // JELLY_SWAP_GRID_VH16_HPP_
