...
class MockFileSystem final : public peanutbutter::ultima::FileSystem {
 public:
  MockFileSystem();
  ...
  std::vector<peanutbutter::ultima::DirectoryEntry> ListFilesRecursive(const std::string& pRootPath) const override;
  std::vector<peanutbutter::ultima::DirectoryEntry> ListFiles(const std::string& pRootPath) const override;
  std::unique_ptr<peanutbutter::ultima::FileReadStream> OpenReadStream(const std::string& pPath) const override;
  std::unique_ptr<peanutbutter::ultima::FileWriteStream> OpenWriteStream(const std::string& pPath) override;
  ...
  void AddFile(const std::string& pPath, const peanutbutter::ultima::ByteVector& pContents);
