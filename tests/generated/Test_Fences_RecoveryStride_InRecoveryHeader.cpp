...
int main() {
  const std::string aCaseDataPath = std::string(PEANUT_BUTTER_ULTIMA_TEST_DATA_DIR) + "/PeanutButterUltimaGenerated_Test_Fences_RecoveryStride_InRecoveryHeader.dat";
